...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 21, 2024 at 08:35 AM
...
INSERT INTO `academicdetails` (`AID`, `SID`, `Batch`, `Year`, `Type`, `Status`, `Achievements`, `CreatedOn`, `DID`, `CID`) VALUES
(14, 'SID2024504', 2021, 1, 'Government', 'InActive', '', '2024-01-06 08:21:44', 1, 1),
(16, 'SID2024905', 2021, 1, 'Government', 'active', '', '2024-01-06 08:45:05', 1, 1),
(26, 'SID2024507', 2021, 3, 'Government-Aided', 'Active', '', '2024-02-08 12:45:07', 1, 1),
(28, 'SID2024729', 2021, 1, 'Government-Aided', 'Active', '', '2024-02-19 11:52:09', 4, 2),
(29, 'SID2024528', 2021, 2, 'Government-Aided', 'Active', '', '2024-03-13 09:32:08', 1, 1),
(30, 'SID2024234', 2021, 1, 'Government-Aided', 'Active', '', '2024-03-13 10:00:34', 1, 1),
(32, 'SID2024851', 2021, 2, 'Government-Aided', 'Active', '', '2024-03-19 12:50:51', 1, 1),
(33, 'SID2024027', 2022, 1, 'Government', 'Active', '', '2024-03-19 12:53:47', 1, 1),
(34, 'SID2024963', 2021, 3, 'Government-Aided', 'Active', '', '2024-03-20 08:36:03', 1, 1);
...
INSERT INTO `teacher` (`TID`, `Name`, `Photo`, `Dob`, `Gender`, `Aadhar`, `Phone`, `Email`, `Password`, `CreatedOn`, `Who`) VALUES
('TID2024101', 'Sukas', 'TID2024101.jpg', '1984-02-08', 'Male', 809839080933, 9054672311, 'sukas@gmail.com', '12345', '2024-01-18 10:33:03', 'teacher'),
('TID2024102', 'Sukas', 'TID2024102.jpg', '1984-02-08', 'Male', 809839080933, 9054672311, 'sukas@gmail.com', '54321', '2024-01-18 10:33:03', 'teacher');
...
--
ALTER TABLE `department`
  ADD CONSTRAINT `fk_dept_cid` FOREIGN KEY (`CID`) REFERENCES `college` (`CID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `dept_subjects`
--
ALTER TABLE `dept_subjects`
  ADD CONSTRAINT `fk_dept_department` FOREIGN KEY (`DID`) REFERENCES `department` (`DID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `teacherdetails`
  ADD CONSTRAINT `fk_dept_teacher` FOREIGN KEY (`DID`) REFERENCES `department` (`DID`) ON DELETE CASCADE ON UPDATE CASCADE,
