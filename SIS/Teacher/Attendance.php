...
<body>
    ...
    <form action="" method="get" id="chooseform" class="col-md-12"  >
        <div class="form-group">
            ...
            <input type="date" name="Date" <?php if(isset($_SESSION['teacher'])) echo "readonly"; ?> value="<?php echo date('Y-m-d'); ?>" id="input-date" class="form-control">
        </div>
        <div class="form-group">
            <label for="">Select Department</label>
            <select name="department" class="form-control">
            <?php 
                $qry="Select DID,DName,college.CollegeName from department inner join  college on college.CID=department.CID where DID=(SELECT DID from teacherdetails where TID='$teacher') ";
        ...
        <script>
            ...
            <?php
                if(isset($_POST['submit_attendance']))
                {
                    ...
                    {   
                        ...
                        try{
                            ...
                            {
                                $flag=1;
                                echo "<script>alert('Attendance Error');</script>";
                                break;
                            }
                        }
                        catch(Exception $e)
                ...
                if(isset($_POST['update_attendance']))
                {
                    ...
                    if($flag!=1)
                    {
                        echo "<script>alert('Attendance Update Submitted');
                            setTimeout(()=>{window.location.href='Attendance.php'},1000)
                        </script>";
