        ...
        <nav class="nav-stacked">
            ...
            <form id="NewStudentForm" action="NewUserHandle.php" enctype="multipart/form-data" method="post" class="d-flex flex-column gap-2 p-2">
                ...
                <div class="col-md-6 col-xs-12 gap-2">
                    ...
                    <li>Name should be started with capital</li>
                    <li>Eg: Muthukrishnan M</li>
                </div>
                    <div class="form-group">
                 ...
                 <li>file should be lesser than 400kb</li>
                 <li>file should be JPEG/PNG</li>  
                  </div>
                    <script>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" required value="<?php if(isset($ResEdit['Aadhaar'])) echo $ResEdit['Aadhaar'];?>" name="Aadhaar" id="input-aadhar" maxlength="12" class="form-control">
                   <li>Aadhar Number should be minimum 12 digits</li>
                    </div>
                    <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" required value="<?php if(isset($ResEdit['Phone'])) echo $ResEdit['Phone'];?>" name="Phone" pattern="^[6-9]{1}[0-9]{9}$" id="input-phone" class="form-control">
                        <li>Phone Number should be 10 digits</li>
                        <li>Phone Number should not begin with less than 6</li>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="Religion" id="" class="form-control">
                            ...
                            <option value="Muslim" <?php if(isset($ResEdit['Religion']) && $ResEdit['Religion']=='Muslim') echo "selected"; ?>>Hindu</option>
                        </select>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6 col-xs-12  gap-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" required value="<?php if(isset($ResEdit['Email'])) echo $ResEdit['Email'];?>" name="Email" id="input-email" class="form-control">
                    
                        <li>Enter the email valid format</li>
                    </div>
                    <div class="form-group">
                    ...
                    <li>Only alphabets and space should be allowed</li>
                    </div>
                    <div class="form-group">
                   ...
                   <li>Only alphabets and space should be allowed</li>
                    ...
                    <li>Phone Number should be 10 digits</li>
                    <li>Phone Number should not begin with less than 6</li></li>
                    </div>
                    <div class="form-group">
            ...
            <div class="tab-content  col-md-12 " id="residential_details" >
                <div class="form-group">
                    <label for="input-address">Address</label>
                    <textarea name="Address" required  id="input-address" class="form-control" placeholder="Door no,Street/Colony,Place,District,Pincode"><?php if(isset($ResEdit['Address'])) echo $ResEdit['Address'];?></textarea>
                </div>
                <div class="form-group">
            ...
            <div class=" tab-content  col-md-12 " id="academic_details" >
                <div class="form-group">
                    ...
                    <input type="number" required class="form-control" placeholder="Eg:2020" value="<?php if(isset($ResEdit['Batch'])) echo $ResEdit['Batch'];?>" name="Batch" id="input-batch">
                </div>
                <div class="form-group">
            ...
            <div class="tab-content  col-md-12 " id="scholarship_details" >
                ...
                <div class="form-group">
                    ...
                    <input type="number" required max="200000" min="1000" placeholder="Eg:1000-200000" value="<?php if(isset($ResEdit['Amount'])) echo $ResEdit['Amount'];?>" id="input-scholaramount" name="Amount" class="form-control">
                </div>
                <div class="form-group">
